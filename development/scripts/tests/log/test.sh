...
source "$(dirname ${BASH_SOURCE})/../../deploy/log/functions.sh";

# Load generic functions script.
source "$(dirname ${BASH_SOURCE})/../../deploy/generic/functions.sh";

# Directory to store log files.
readonly test_log_directory="${output_files_directory}tests/log/";
...
test_log_write_on_file(){
    ...
    local readonly valid_test_file_path="${output_files_directory}/tests/log/test_log_write_on_file.log";
    local readonly invalid_test_file_path="${output_files_directory}/tests/log/invalid_test_log_write_on_file.log";
