...
void test_packages(){
    ...
    printf("-------------------------\n");
    printf("Check connection package:\n");
    printf("-------------------------\n");
    ...
    printf("------------------------\n");
    printf("Send file chunk package:\n");
    printf("------------------------\n");
    ...
    printf("-------------------------\n");
    printf("Send file header package:\n");
    printf("-------------------------\n");
    ...
    printf("--------------------------\n");
    printf("Send file trailer package:\n");
    printf("--------------------------\n");
...
void test_package(package_t package) {
    ...
    printf("Package to byte array conversion result: %d\n", convertion_result);
    printf("Byte array created from package:\n");
    print_byte_array(byte_array);
    convertion_result = convert_byte_array_to_package(&converted_package, byte_array);
    printf("Byte array to package conversion result: %d\n", convertion_result);
...
void print_package_content(uint32_t package_type, content_t content){
    ...
    switch (package_type) {
        ...
        case COMMAND_RESULT_CODE:
            ...
            printf("\tDelay time: %06ld.%06ld\n", content.command_result_content->execution_delay.tv_sec, content.command_result_content->execution_delay.tv_usec);
            break;
