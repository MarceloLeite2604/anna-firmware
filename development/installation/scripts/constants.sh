...
# Name of the script which creates system services.
if [ -z "${create_services_script_name}" ];
then
    readonly create_services_script_name="create_services.sh";
fi;
...
then
    readonly base_installation_directory_path="${base_directory_path}${installation_directory_name}";
fi;
...
# Path to the services creation scripts.
if [ -z "${base_installation_create_services_scripts_directory_path}" ];
then
   readonly base_installation_create_services_scripts_directory_path="${base_installation_scripts_directory_path}services/";
fi;

# Path to the script which creates system services.
if [ -z "${base_installation_create_services_script_path}" ];
then
    readonly base_installation_create_services_script_path="${base_installation_create_services_scripts_directory_path}${create_services_script_name}";
fi;
...
# Path to system services' files' directory on base.
if [ -z "${base_installation_services_directory_path}" ];
then
    readonly base_installation_services_directory_path="${base_installation_directory_path}services/";
fi;

# Path to system variables' script's directory on base.
if [ -z "${base_installation_system_variables_script_directory_path}" ];
then
    readonly base_installation_system_variables_script_directory_path="${base_installation_directory_path}system_variables_script/";
fi;
...
# Path to shell scripts' directory on destination directory.
if [ -z "${destination_scripts_directory_path}" ];
then
    readonly destination_scripts_directory_path="${destination_directory_path}${scripts_directory_name}";
fi;

# Path to services' shell scripts' directory on destination directory.
if [ -z "${destination_services_scripts_directory_path}" ];
then
    readonly destination_services_scripts_directory_path="${destination_scripts_directory_path}services/";
fi;
...
then
    readonly destination_create_additional_directories_script_path="${destination_scripts_directory_path}${create_additional_directories_script_name}";
fi;

# Path to directories' shell scripts' directory path on destination directory.
if [ -z "${destination_directory_scripts_directory_path}" ];
then
    readonly destination_directory_scripts_directory_path="${destination_scripts_directory_path}directories/";
fi;
...
then
    readonly destination_file_name_location_input_files_script_path="${destination_directory_scripts_directory_path}${file_name_location_input_files_script}";
fi;
...
then
    readonly destination_file_name_location_output_files_script_path="${destination_directory_scripts_directory_path}${file_name_location_output_files_script}";
fi;
...
then
    readonly destination_file_name_location_binaries_script_path="${destination_directory_scripts_directory_path}${file_name_location_binaries_script}";
fi;
...
then
    readonly temporary_build_directory_path="${temporary_directory_path}build/";
fi;
...
then
    readonly temporary_unit_files_directory_path="${temporary_directory_path}units/";
fi;

# Path to temporary script files directory.
if [ -z "${temporary_script_files_directory_path}" ];
then
    readonly temporary_script_files_directory_path="${temporary_directory_path}scripts/";
fi;
